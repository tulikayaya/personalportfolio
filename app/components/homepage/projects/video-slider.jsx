        ...
        {videosData.map((video, index) => (
          ...
          >
            <div className="relative overflow-hidden rounded-t-lg">
              ...
              {/* PUBLICATION: shows screenshot thumbnail */}
              {video.type === "publication" ? (
                <img
                  src={video.thumbnail}
                  alt={video.title}
                  className="w-full h-64 object-cover cursor-pointer"
                  onClick={() => handleWatchNow(video.publicationUrl)}
                />
              ) : (
              /* VIDEO: shows YouTube embed */
                <iframe
            ...
            <div className="px-4 py-3">
              ...
              <div className="flex gap-2 mt-2">
                <button
                  onClick={() => handleWatchNow(video.type === "publication" ? video.publicationUrl : video.videourl)}
                  className="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-all"
                >
                  {video.type === "publication" ? "View Publication" : "Watch Now"}
                </button>
              </div>
            </div>
          </div>
